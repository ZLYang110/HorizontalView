...
public class TitleView extends LinearLayout {
    ...
    private int defaultTitleBackgroundColorId = R.color.transparent;// 默认背景颜色
    private int defaultTitleTextColorId = R.color.black;// 默认文字颜色
    private int defaultTitleLineColorId = R.color.Grey100;// 默认底部线条颜色
